...
export function Footer() {
    return (
        <footer className="py-20 bg-zinc-950 text-white">
            <Container>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20 px-6 sm:px-0">
                ...
                <div className="pt-8 border-t border-zinc-900 flex flex-col md:flex-row items-center justify-between text-xs text-zinc-500 gap-4 text-center md:text-left px-6 sm:px-0">
