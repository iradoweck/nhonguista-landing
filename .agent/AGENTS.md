# Regras Dogmáticas - Nhonguista Landing Page
...
6. **Live Reloading:** Sempre que fizer uma edição no código-fonte, atualize (reload) a página do localhost no navegador para refletir imediatamente as alterações.
7. **Identidade e Governança:** Este repositório (`landing`) é um subproduto dependente do ecossistema Nhonguista. O projeto principal Nhonguista atua como upstream. O que publicamos aqui é a fonte da verdade para a comunidade. Nós aprovamos ou rejeitamos PRs externos.
